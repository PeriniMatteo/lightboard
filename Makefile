...
# Generated by qmake (2.01a) (Qt 4.8.6) on: gio nov 19 10:44:01 2015
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -ludev -lX11 -lXtst -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/lightboard1.0.0/ && $(COPY_FILE) --parents include/main.h include/QProgressIndicator.h .tmp/lightboard1.0.0/ && $(COPY_FILE) --parents systray.qrc .tmp/lightboard1.0.0/ && $(COPY_FILE) --parents src/calibration.cpp src/main.cpp lib/core.c lib/monitor.c lib/QProgressIndicator.cpp .tmp/lightboard1.0.0/ && (cd `dirname .tmp/lightboard1.0.0` && $(TAR) lightboard1.0.0.tar lightboard1.0.0 && $(COMPRESS) lightboard1.0.0.tar) && $(MOVE) `dirname .tmp/lightboard1.0.0`/lightboard1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/lightboard1.0.0
