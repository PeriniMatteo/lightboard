...
# Generated by qmake (2.01a) (Qt 4.8.6) on: mar dic 1 15:37:51 2015
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/lightboard1.0.0/ && $(COPY_FILE) --parents include/main.h include/QProgressIndicator.h .tmp/lightboard1.0.0/ && $(COPY_FILE) --parents systray.qrc .tmp/lightboard1.0.0/ && $(COPY_FILE) --parents src/calibration.cpp src/main.cpp lib/core.c lib/monitor.c lib/QProgressIndicator.cpp .tmp/lightboard1.0.0/ && $(COPY_FILE) --parents lightboard_en.ts lightboard_it.ts .tmp/lightboard1.0.0/ && (cd `dirname .tmp/lightboard1.0.0` && $(TAR) lightboard1.0.0.tar lightboard1.0.0 && $(COMPRESS) lightboard1.0.0.tar) && $(MOVE) `dirname .tmp/lightboard1.0.0`/lightboard1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/lightboard1.0.0
